require_relative '../models1/address_book'
  ...
  describe "attributes" do
   ...
   context "#remove_entry" do
     it "removes an entry using the name, phone_number, and email address" do
       book = AddressBook.new
       book.add_entry("Cookie Monster", "509.263.3637", "cookie.monster@sesame.com")
       ...
       expect(book.entries.first.name).to eq("Cookie Monster")
     end
   end
